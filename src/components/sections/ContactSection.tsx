          ...
          <RevealSection delay={200} direction="right">
            <form className="space-y-5 md:space-y-6">
              ...
              <motion.button
                ...
                className="w-full sm:w-auto mt-2 md:mt-4 inline-flex items-center justify-center gap-3 md:gap-4 font-mono text-xs md:text-sm uppercase tracking-[0.15em] text-primary-foreground bg-primary px-6 md:px-8 py-3 md:py-4 hover:bg-foreground hover:text-background transition-colors duration-medium"
              >
