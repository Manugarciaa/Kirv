            ...
            <div className="relative">
              <RevealSection>
                <div className="hidden md:flex items-center gap-3">
                  ...
                  <TechLabel>Diseño de Experiencia</TechLabel>
                </div>
                <div className="relative inline-block">
                  <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-foreground mt-3 leading-[1.1]">
                    Diseñar una experiencia que enamore
                  </h1>
                  <img
                    src="/img/paper-crane.svg"
                    alt=""
                    aria-hidden="true"
              ...
              <RevealSection delay={200}>
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-md">
                  Exploramos objetivos, usuarios y contexto para construir flujos
                  claros y agradables. Unimos rigor técnico con sensibilidad de
                  producto para resultados que importan.
                </p>
              </RevealSection>
            </div>
