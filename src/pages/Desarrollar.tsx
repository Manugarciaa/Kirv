              ...
              <div className="relative">
                <RevealSection>
                  <div className="hidden md:flex items-center gap-3">
                    ...
                    <TechLabel>Desarrollo a Medida</TechLabel>
                  </div>
                ...
                <RevealSection delay={200}>
                  <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-md">
                    Construimos sitios y aplicaciones a medida, escalables y
                    mantenibles, alineados a tu identidad de producto y objetivos
                    de negocio.
                  </p>
                </RevealSection>
              </div>
