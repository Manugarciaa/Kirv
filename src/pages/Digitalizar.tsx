              ...
              <div className="relative">
                <RevealSection>
                  <div className="hidden md:flex items-center gap-3">
                    ...
                    <TechLabel>Digitalización</TechLabel>
                  </div>
                  <div className="relative inline-block">
                    <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-foreground mt-3 leading-[1.1]">
                      Digitalizar procesos clave de tu empresa.
                    </h1>
                    <img
                      src="/img/samurai.svg"
                      alt=""
                      aria-hidden="true"
                      className="absolute -bottom-1 right-5 md:right-0 h-20 md:h-28 lg:h-32 opacity-35 pointer-events-none dark:filter dark:invert dark:brightness-200"
                    />
                  </div>
                </RevealSection>
                ...
                <RevealSection delay={200}>
                  <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-md">
                    Estandarizamos y digitalizamos procesos críticos para mejorar
                    trazabilidad, calidad y tiempos. Diseñamos sistemas que escalan
                    con tu operación.
                  </p>
                </RevealSection>
              </div>
