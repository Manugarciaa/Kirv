  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "draw-line": "draw-line 1s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "slide-left": "slide-left 0.8s cubic-bezier(0.25, 0.1, 0.25, 1) forwards",
        "slide-right": "slide-right 0.8s cubic-bezier(0.25, 0.1, 0.25, 1) forwards",
